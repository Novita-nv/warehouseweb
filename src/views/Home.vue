  ...
  <div class="flex max-w-screen">
    <div class="bg-dark-purple w-2/4 h-screen p-10">
        ...
        <div class="h-full flex justify-center items-center">
          <img class="w-3/4 text-center" src="/images/Forklift.png" alt="" />
        </div>
    </div>
    <div class="h-full flex flex-col justify-center bg-light-purple w-2/4 h-screen">      
        ...
        <div class="text-left text-black mb-4 p-10">
          ...
          <div class="text-left text-1xl text-black mb-4 p-10">Welcome to Warehouse Manager Application!
          </div>
    </div>
  </div>
</template>
